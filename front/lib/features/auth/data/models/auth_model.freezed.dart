...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.email, email) || other.email == email)&&(identical(other.pw, pw) || other.pw == pw)&&(identical(other.image, image) || other.image == image));
}
...
@override
String toString() {
  return 'AuthModel(id: $id, name: $name, email: $email, pw: $pw, image: $image)';
}
...
class _AuthModel implements AuthModel {
  const _AuthModel({@JsonKey(name: "_id") required this.id, required this.name, required this.email, required this.pw, required this.image});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AuthModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.email, email) || other.email == email)&&(identical(other.pw, pw) || other.pw == pw)&&(identical(other.image, image) || other.image == image));
}
